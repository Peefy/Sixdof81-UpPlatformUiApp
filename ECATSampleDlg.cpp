...
void SixdofControl()
{
	...
	{	
		...
		else
		{
			...
			auto x = RANGE(0 - deltax, -MAX_XYZ, MAX_XYZ);
			auto y = RANGE(0 - deltay, -MAX_XYZ, MAX_XYZ);
			auto z = RANGE(0 - deltaz, -MAX_XYZ, MAX_XYZ);
			auto roll = RANGE(0 - deltaroll + lastData.Roll, -MAX_DEG, MAX_DEG);
			auto pitch = RANGE(0 - deltapitch + lastData.Pitch, -MAX_DEG, MAX_DEG);
			auto yaw = RANGE(0 - deltayaw, -MAX_DEG, MAX_DEG);
